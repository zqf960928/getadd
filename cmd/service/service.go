...
import (
	...
	grpc "github.com/zqf960928/getadd/pkg/grpc"
	pb "github.com/zqf960928/getadd/pkg/grpc/pb"
	service "github.com/zqf960928/getadd/pkg/service"
	"net"
	http1 "net/http"
	"os"
	"os/signal"
...
var fs = flag.NewFlagSet("GetAdd", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		endpoint, err := zipkingo.NewEndpoint("GetAdd", "localhost:80")
		if err != nil {
			logger.Log("err", err)
			os.Exit(1)
		}
...
func initGRPCHandler(endpoints endpoint.Endpoints, g *group.Group) {
	...
	g.Add(func() error {
		...
		pb.RegisterGetAddServer(baseServer, grpcServer)
